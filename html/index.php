...
<body class="container mx-auto bg-zinc-950 bg-opacity-95 text-gray-200 font-sans m-0 relative">
    ...
    <div id="avatarUpdatePanel"
        ...
        <div class="bg-zinc-900 p-4 rounded-lg shadow-lg w-1/3">
            <h3 class="text-lg font-semibold mb-3"><i class="fa-regular fa-image mr-2 text-xl"></i>CHANGE AVATAR<span
                    class="text-xs ml-8 text-gray-300 font-mono"><i
                        class="fa-solid fa-info text-purple-300 text-sm mr-1"></i>(Will be used for the Leaderboard and
                    your Profile)</span></h3>
            <input type="text" id="avatarUrlInput" class="border border-gray-300 p-2 w-full rounded-md"
    ...
    <button id="updateAvatar"
        class="clock-container absolute text-white text-sm p-1.5 rounded-lg right-40 top-1 font-medium"><i
            class="fa-regular fa-image text-purple-400 mr-2"></i>Change Avatar</button>
    <script>
    function updateTime() {
        const now = new Date();
    ...
    <div
        class="nav-menu fixed bottom-0 left-0 right-0 bg-zinc-900 bg-opacity-95 p-2 flex justify-around items-center shadow-lg">
    ...
    <div class="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="md:col-span-2">
            <div
                class="panel bg-gradient-to-r from-zinc-950 to-zinc-900 bg-opacity-95 p-5 rounded-lg shadow-lg drop-shadow-lg">
                ...
                <div class="content">
                    ...
                    <div class="news-item mb-4">
                        <img src="https://i.ibb.co/yXrtCWf/neues-1.webp" alt="News 1" id="newsImage1"
                            class="newsImage1 rounded-lg shadow-lg h-40 object-cover mb-2">
                        <h3 class="text-lg text-white font-semibold mb-1 uppercase"><i
                                class="fa-solid fa-thumbtack mr-2"></i>YOUR NEWS GO HERE</h3>
                        <p class="text-xs text-gray-300 mb-8 font-thin">Short description for news 1. Lorem ipsum dolor
                            sit amet consectetur adipisicing elit. Accusamus voluptatem odit vero dicta. Id voluptatem,
                            aspernatur totam numquam voluptate fuga obcaecati. Sed ut perspiciatis minima. Amet quidem
                            aut quis debitis.</p>
                        <div class="tags">
                            <span class="tag text-xs bg-red-500 text-white rounded-full px-2 py-1 mr-1 font-bold"><i
                                    class="fa-solid fa-bullhorn mr-2"></i>Announcement</span>
                            <span class="tag text-xs bg-gray-800 text-white rounded-full px-2 py-1 mr-1 font-bold"><i
                                    class="fa-solid fa-wrench mr-2"></i>Update</span>
                            <span class="tag text-xs bg-purple-800 text-white rounded-full px-2 py-1 mr-1 font-bold"><i
                                    class="fa-solid fa-calendar-check mr-2"></i>Event</span>
                        </div>
                        <a href="#"
                            class="read-more absolute bottom-4 right-2 text-xs bg-zinc-800 text-white rounded-full px-2 py-1"><i
                                class="fa-solid fa-arrow-up-right-from-square mr-2 text-xs"></i>Read more..</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel bg-zinc-900 bg-opacity-95 p-5 rounded-lg shadow-lg drop-shadow-lg">
            <div>
                <h2 class="panel-heading uppercase font-black font-mono">
                    <i class="fa-regular fa-circle text-xs mr-2"></i>Server Panel<span
                        class="text-sm absolute right-14 text-gray-300"><i
                            class="fa-brands fa-discord mr-2 mt-1"></i>DSC.GG/YOURSERVER</span>
                </h2>
                ...
                <!-- Online Players List -->
                <div
                    class="online-players mt-4 bg-zinc-900 bg-opacity-90 p-5 rounded-lg shadow-inner max-h-60 overflow-y-auto">
                    <!-- Detailed User Info Container -->
                    <div id="detailedUserInfo"
                        class="absolute top-0 left-0 w-full h-full bg-zinc-900 text-white p-4 rounded-lg shadow-xl opacity-0 transition-opacity duration-500 z-10 hidden">
                        ...
                        <div class="flex items-center mb-4">
                            <img src="player-avatar.jpg" alt="Player Image" class="w-16 h-16 rounded-full mr-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <p id="jobNameDetail" class="info-item">Job: <span class="text-blue-400">Not
                                    available</span></p>
                            <p id="jobGradeDetail" class="info-item">Grade: <span class="text-blue-400">Not
                                    available</span></p>
                            <p id="heightDetail" class="info-item">Height: <span class="text-blue-400">Not
                                    available</span></p>
                            <p id="sexDetail" class="info-item">Sex: <span class="text-blue-400">Not available</span>
                            </p>
                            <p id="dobDetail" class="info-item">DOB: <span class="text-blue-400">Not available</span>
                            </p>
                    ...
                    <h3 class="text-md text-white font-semibold mb-2 relative overflow-hidden uppercase"><i
                            class="fa-solid fa-users mr-2 text-white text-sm"></i>Users <span
                            class="text-purple-400">Online</span>
                        <!-- Animated Line -->
                        <span
                            class="block h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 absolute bottom-0 left-0 right-0 animate-pulse"></span>
                    </h3>
                    <ul id="playerList" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Filler Players -->
                        <li
                            class="player-item inline-flex items-center rounded-md bg-zinc-900 px-2 py-1 text-xs font-medium text-purple-700 ring-2 ring-inset ring-gray-600/10">
        ...
        <div
            class="tebex-shop-panel bg-zinc-900 bg-opacity-90 p-5 rounded-xl shadow-xl transform hover:scale-105 transition duration-300">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="font-semibold text-lg text-green-400">
                        <i class="fa-solid fa-shopping-cart text-sm mr-2"></i>Visit <span
                            class="text-green-400">our</span> Store.
                    </h2>
                    <h2>
            ...
            <p class="text-sm text-gray-300 mt-4">
                Check out exclusive items and special offers available in our Tebex Shop. Lorem ipsum dolor sit amet
            ...
            <ul class="grid w-full gap-2 md:grid-cols-1 absolute bottom-0 right-0">
                <li>
                    ...
                    <label for="hosting-small"
                        class="scur inline-flex items-center justify-between w-full p-2 text-gray-500 bg-white rounded-lg cursor-pointer dark:hover:text-gray-300 dark:peer-checked:text-green-400 peer-checked:text-green-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-zinc-900 dark:hover:bg-gray-700">
                        <div class="block">
                            ...
                            <div class="w-full text-xs ml-12"><i class="fa-solid fa-tags mr-1"></i>Your Product<span
                                    class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2 py-0 rounded-full dark:bg-green-900 dark:text-green-300 ml-2">$24.99</span>
                            </div>
                        </div>
        ...
        <div
            class="get-support-panel bg-zinc-900 bg-opacity-90 p-5 rounded-xl shadow-xl transform hover:scale-105 transition duration-300">
            <img src="./assets/get_support.png" alt="Tebex Shop Background" class="tebex-shop-bg">
            <div class="flex items-center justify-between">
                <h2 class="font-semibold text-lg text-blue-400">
                    <i class="fa-solid fa-headset text-sm mr-2 text-white"></i>Need <span
                        class="text-white">Assistance?</span>
                </h2>
                <img src="./assets/discord_logo.webp" alt="Discord Logo" class="rounded-full w-16 h-16">
            </div>
            <p class="text-sm text-gray-100 mt-4">
                Our dedicated support team is here to assist you. Feel free to reach out with any queries or concerns.
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, sapiente.
            </p>
            <button type="button"
                class="inline-flex items-center px-3 py-1.5 text-sm font-bold text-center text-white bg-zinc-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-zinc-800 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <i class="fa-solid fa-ticket mr-2 text-blue-400"></i>Live Support
            </button>
            <button id="discord-btn" type="button" onclick="copyDiscordLink()"
                class="inline-flex items-center px-3 py-1.5 text-sm font-bold text-center text-white bg-zinc-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-zinc-800 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-2 mt-7">
        ...
        <div id="notification-modal"
            class="hidden fixed inset-0 bg-zinc-900 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
        ...
        <div class="leaderboard-panel bg-zinc-950 bg-opacity-50 p-4 rounded-xl shadow-xl overflow-y-auto max-h-64">
            ...
            <h2 class="text-lg font-semibold text-white mb-4 flex items-center">
                ...
                Leaderboard<span class="text-xs font-thin ml-4">Only the first 10 with the most Playtime are
                    displayed.</span>
            </h2>
            <ul class="space-y-2">
                <!-- Leaderboard Item -->
                <li
                    class="flex items-center justify-between bg-gradient-to-r from-zinc-950 to-zinc-900 bg-opacity-95 p-2 rounded-lg">
                    <div class="flex items-center">
                        <img src="./assets/pxrp.gif" alt="Player 1" class="w-8 h-8 rounded-full mr-2">
                        <span class="text-white text-sm">Player 1</span><i class="fa-solid fa-trophy fa-beat fa-xs ml-4"
                            style="color: #ffff80;"></i>
                    </div>
                    <span class="badge bg-gray-800 text-white text-xs px-2 py-1 rounded-full font-bold shadow-lg">Score:
                        1500</span>
                </li>
                ...
                <li
                    class="flex items-center justify-between bg-gradient-to-r from-zinc-950 to-zinc-900 bg-opacity-95 p-2 rounded-lg">
                    <div class="flex items-center">
                        <img src="https://i.ibb.co/CwByvYM/empress-purple.webp" alt="Player 1"
                            class="w-8 h-8 rounded-full mr-2">
                        <span class="text-white text-sm">Player 2</span><i class="fa-solid fa-trophy fa-beat fa-xs ml-4"
                            style="color: #c9c9c9;"></i>
                    </div>
                    <span class="badge bg-gray-800 text-white text-xs px-2 py-1 rounded-full font-bold shadow-lg">Score:
                        1330</span>
                </li>
                <li
                    class="flex items-center justify-between bg-gradient-to-r from-zinc-950 to-zinc-900 bg-opacity-95 p-2 rounded-lg">
                    <div class="flex items-center">
                        <img src="https://i.ibb.co/r4KmhTG/animated-lp.webp" alt="Player 1"
                            class="w-8 h-8 rounded-full mr-2">
                        <span class="text-white text-sm">Player 3</span><i class="fa-solid fa-trophy fa-beat fa-xs ml-4"
                            style="color: #b87536;"></i>
                    </div>
                    <span class="badge bg-gray-800 text-white text-xs px-2 py-1 rounded-full font-bold shadow-lg">Score:
                        755</span>
                </li>
            ...
            if (item.type === "updateLeaderboard") {
                ...
                item.players.forEach(function(player, index) {
                    ...
                    playerElement.className =
                        'flex items-center justify-between bg-gradient-to-r from-zinc-950 to-zinc-900 bg-opacity-95 p-2 rounded-lg';
                    ...
                    if (index === 0) { // First place
                        ...
                        trophyIcon =
                        '<i class="fa-solid fa-trophy" style="color: #cd7f32;"></i>'; // Bronze color
                    }
        ...
        <div id="modal-container"
            class="hidden fixed inset-0 bg-zinc-950 bg-opacity-30 overflow-y-auto h-full w-full flex justify-center items-center"
            aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <!-- Modal Content -->
            <div
                class="relative top-0 mx-auto p-7 border-2 w-full md:w-1/2 lg:w-1/3 shadow-xl rounded-lg bg-zinc-900 space-y-4">
                <!-- Form Title -->
                <h2 class="text-2xl font-semibold text-white uppercase"><i
                        class="fa-solid fa-user-large-slash text-purple-300 mr-2"></i>Report a Player</h2>

                <!-- Form Container -->
                <div class="form-container space-y-3">
                    <!-- Form Fields -->
                    <input type="text" id="fname" placeholder="First Name"
                        class="w-full px-4 py-2 border rounded-md focus:border-purple-500 focus:outline-none bg-zinc-800 text-white">
                    <input type="text" id="lname" placeholder="Last Name"
                        class="w-full px-4 py-2 border rounded-md focus:border-purple-500 focus:outline-none bg-zinc-800 text-white">
                    <select id="reporttype"
                        class="text-gray-300 w-full px-4 py-2 border rounded-md focus:border-purple-500 focus:outline-none bg-zinc-800">
                    ...
                    <textarea id="description" placeholder="Description"
                        class="w-full h-32 px-4 py-2 border rounded-md focus:border-purple-500 focus:outline-none bg-zinc-800 text-white"></textarea>

                    <!-- Submit Button -->
                    <button id="form-submit-btn"
                        class="w-full bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded transition duration-200">
                        Submit Report
                    </button>
                </div>
                <!-- Close Button -->
                <button id="close-modal-btn"
                    class="bg-zinc-800 hover:bg-zinc-700 text-red-500 font-bold py-2 px-4 rounded absolute top-1 right-6 transition duration-200">
        ...
        <div class="panel bg-zinc-900 bg-opacity-90 p-2 rounded-lg shadow-lg col-span-1">
            ...
            <div class="bg-zinc-900 bg-opacity-90 p-4 rounded-lg">
                <h2 class="font-semibold text-lg text-white mb-4 panel-heading">
                    ...
                    <span class="text-xs font-medium ml-4 font-sans">This is a sample text and will soon be
                        replaced.</span>
                </h2>
                <div class="calendar-row flex overflow-x-auto pb-2">
                    ...
                    <div class="reports bg-gradient-to-r from-zinc-950 to-zinc-900 rounded-lg shadow-lg mr-4 ml-2 flex-none hover:scale-105 transition-transform"
                        onclick="openModal()">
                        <div
                            class="day-header bg-zinc-950 text-white text-center py-1.5 rounded-t-lg font-bold text-xss">
                            Report Player
                        </div>
                    ...
                    <!-- ... other report cards ... -->
                    <div
                        class="reports bg-gradient-to-r from-zinc-950 to-zinc-900 rounded-lg shadow-lg mr-4 ml-2 flex-none hover:scale-105 transition-transform">
                        <div
                            class="day-header bg-zinc-950 text-white text-center py-1.5 rounded-t-lg font-bold text-xss">
                            Report Bugs
                        </div>
        ...
        <div class="panel bg-zinc-900 bg-opacity-90 p-2 rounded-lg shadow-lg col-span-1">
            ...
            <div class="advent-calendar-panel bg-zinc-900 bg-opacity-90 p-4 rounded-lg">
                <h2 class="font-semibold text-lg text-white mb-4 panel-heading"><i
                        class="fa-solid fa-calendar-day mr-2 text-purple-400"></i>Daily<span class="text-purple-400">
                        Rewards</span><span class="text-xs font-medium ml-4 font-sans">This is a sample text and will
                        soon be replaced.</span></h2>
                <div class="calendar-row flex overflow-x-auto pb-2">
                    <!-- Calendar Days -->
                    <div
                        class="calender-door bg-gradient-to-r from-zinc-950 to-zinc-900 rounded-lg shadow-lg mr-4 ml-2 flex-none hover:scale-105 transition-transform opened">
                        <div
                            class="day-header bg-zinc-950 text-white text-center py-1.5 rounded-t-lg font-bold text-xs">
                            DAY 1
                        </div>
                        <div class="day-content flex items-center justify-center p-4 h-14">
                            ...
                            <div class="open-icon absolute top-3 right-0 transform -translate-x-1/2 -translate-y-1/2">
                                ...
                                <!-- Replace with your lock icon -->
                            </div>
                        </div>
                    </div>
                    <!-- Calendar Days -->
                    <div
                        class="calender-door bg-gradient-to-r from-zinc-950 to-zinc-900 rounded-lg shadow-lg mr-4 flex-none hover:scale-105 transition-transform obtainable">
                        <div
                            class="day-header bg-zinc-950 text-white text-center py-1.5 rounded-t-lg font-bold text-xs">
                            DAY 2
                        </div>
                    ...
                    <!-- Calendar Days -->
                    <div
                        class="calender-door bg-gradient-to-r from-zinc-950 to-zinc-900 rounded-lg shadow-lg mr-4 flex-none hover:scale-105 transition-transform locked relative">
                        <div
                            class="day-header bg-zinc-950 text-white text-center py-1.5 rounded-t-lg font-bold text-xs">
                            DAY 3
                        </div>
        ...
        <div class="chatbox-panel bg-zinc-900 bg-opacity-90 p-5 rounded-xl shadow-xl">
            <h2 class="text-lg font-semibold text-white mb-4"><i class="fa-regular fa-comments mr-2"></i>Community Chat
            </h2>
            ...
            <form id="chat-form" class="flex items-center">
                ...
                <input type="text" id="chat-input" class="bg-zinc-800 text-white p-1.5 rounded-lg w-full"
                    placeholder="Type a message...">
                <button type="submit" class="bg-purple-400 text-white p-1.5 rounded-lg font-bold">Send</button>

                <div id="emoji-picker"
                    class="emoji-picker hidden absolute bg-zinc-900 bg-opacity-90 p-2 border border-gray-300 rounded-lg bottom-36 right-80">
                    <div class="p-2">
        ...
        window.addEventListener('message', function(event) {
            ...
            if (item.type === "chatMessage") {
                ...
                newMessage.innerHTML =
                    `[<span class="text-purple-400">${item.id}</span>] <strong>${item.username}</strong>: ${item.message} <span class="text-xss text-gray-500 relative">${item.timestamp}</span>`;
